...
export default function RelateStatement() {
  ...
  const handleAnswer = (answer: string) => {
    ...
    router.push('/onboarding/relate-statement-2');
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.progressBar}>
          <View style={[styles.progressFill, { width: `${21 / 22 * 100}%` }]} />
        </View>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.statementContainer}>
          <Text style={styles.statement}>
            I frequently experience unpleasant aftereffects from drinking, such as headaches, fatigue, or sluggishness.
          </Text>
        </View>
